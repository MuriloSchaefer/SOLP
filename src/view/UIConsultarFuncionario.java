 ...
 * @author murilo
 */
public class UIConsultarFuncionario extends javax.swing.JFrame {
    ...
    public UIConsultarFuncionario() throws ClassNotFoundException, SQLException {
        ...
        for(int i=0; i<n; i++){
            ...
            if(lista.get(i).getPermissoes() > 0){
                aux = "Gerente";
            } else{
                aux = "Funcionário";
            }
    ...
    private void txtNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomeKeyReleased
        ...
        try {
            ...
            Logger.getLogger(UIConsultarFuncionario.class.getName()).log(Level.SEVERE, null, ex);
        }
        String[] columnNames = {"Id",
            "Nome",
            "CPF",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIConsultarFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
