...
public class UICadastrarCliente extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UICadastrarCliente
     */
    public UICadastrarCliente() {
        initComponents();
    }
                        ...
                        .addGroup(PanelEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(PanelEnderecoLayout.createSequentialGroup()
                                .addGroup(PanelEnderecoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(PanelEnderecoLayout.createSequentialGroup()
                                        .addComponent(txtCidade, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    */
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Cliente cliente = new Cliente(); // cria um objeto do tipo cliente
        cliente.setCnpj(txtCNPJ.getText()); // atribuição de valores
        cliente.setListaEndereco(enderecos);
        cliente.setNomeFantasia(txtNomeFantasia.getText());
        cliente.setRazaoSocial(txtRazaoSocial.getText());
        try {
            add = controladorCliente.add(cliente); // chama método do controlador para adição do cliente
        } catch (ClassNotFoundException | NoSuchAlgorithmException | SQLException ex) {
            Logger.getLogger(UICadastrarCliente.class.getName()).log(Level.SEVERE, null, ex);
        }

        if(add){ //caso consiga inserir um novo cliente
            JOptionPane.showMessageDialog(rootPane, "Cliente cadastrado com sucesso!");
            this.dispose();
        } else{ //caso não consiga inserir um novo cliente
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UICadastrarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UICadastrarCliente().setVisible(true);
            }
        });
    }
